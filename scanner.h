...
typedef enum { 
    ...
    T_VEC2, T_VEC3, T_VEC4, T_MAT2, T_MAT3, T_MAT4, T_IVEC2, T_IN, T_OUT, T_INOUT, T_LAYOUT,
    T_UNIFORM,
    T_NumTokenTypes
} TokenType;
...
static const char *gTokenNames[T_NumTokenTypes] = {
  ...
  "T_ReadInteger", "T_ReadLine", "T_Vec2", "T_Vec3", "T_Vec4", "T_Mat2", "T_Mat3", "T_Mat4", "T_Ivec2", "T_In",
  "T_Out", "T_Inout", "T_Layout", "T_Uniform"
};
